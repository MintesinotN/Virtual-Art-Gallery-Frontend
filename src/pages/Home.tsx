...
const Home: React.FC = () => {
    ...
    const Artists:artists[] = [
        ...
        {
          name: "Michelangelo",
          image: "https://t2.gstatic.com/licensed-image?q=tbn:ANd9GcQWgUUwNIOxGyvuo7_2_I4vGhsJFr6-zUgtACdANGpDwKzmymBDN8m4xMVmVZ_ew2C5"
        },
        {
          name: "Leonardo da Vinci",
          image: "https://t3.gstatic.com/licensed-image?q=tbn:ANd9GcSn9ASPssbShveAIP6lPRx9FqqQFcSOfMgbR4HwVpkm5qdof7PUUmRbCsaFpCRGhnbJ"
        }
    ]
    ...
    const Artworks:artists[] = [
      ...
      },
      {
        ...
        image:"https://upload.wikimedia.org/wikipedia/commons/c/c7/Madonna_benois_01.jpg"
      },
      {
        name:"Pablo Picasso",
  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-[#121212] text-gray-900 dark:text-gray-200">
      ...
      <section className="bg-[url(./assets/homebackground.jpg)] dark:bg-[url(./assets/darkhomebackground2.jpg)] bg-cover bg-no-repeat  h-[80vh] bg-[center] flex flex-col items-center justify-center text-center px-6 bg-gray-900 dark:bg-[#1E1E1E] text-white">
        <h1 className="rum-raisin-regular text-5xl font-bold mb-4">Experience Art Like Never Before</h1>
        <p className="text-lg mb-6 max-w-2xl">
        Discover breathtaking artworks, connect with talented artists, and immerse yourself in a world of creativity.
        </p>
        <a
          href="#explore"
      ...
      <section className="py-16 px-6">
        <h2 className="text-3xl font-semibold text-center mb-8 lobster-regular">Featured Artworks</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 max-xl:gap-3 gap-6 max-w-6xl sm:max-md:mx-24 mx-auto">
          {/* Sample Artwork Cards */}
          {Artworks.map((art) => (
            <div key={art.name} className="mb-4 h-fit relative bg-white dark:bg-[#1E1E1E] rounded-xs shadow-lg overflow-hidden duration-300 hover:contrast-125">
              <img
                src={art.image}
                alt="Artwork"
      ...
      <section className="py-16 px-6 bg-gray-200 dark:bg-[#181818]">
        <h2 className="text-3xl font-semibold text-center mb-8 lobster-regular">Legend Artists</h2>
        <div className="grid grid-cols-1 md:grid-cols-3  max-xl:gap-3 gap-6 max-w-6xl sm:max-md:mx-24 mx-auto">
          {/* Sample Artist Profiles */}
          {Artists.map((artist:artists) => (
            <div key={artist.name} className="group h-fit max-h-96 relative bg-white dark:bg-[#1E1E1E] rounded-xs shadow-lg overflow-hidden text-center">
              <img
                src={artist.image}
                alt="Artist"
              ...
              <p className="text-sm">Painter, Sculptor, Printmaker, Ceramicist, and Theatre designer</p>
