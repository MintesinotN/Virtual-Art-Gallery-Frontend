...
const SignUp: React.FC = () => {
  ...
  return (
    <div className="min-h-[70vh] flex items-center justify-center bg-gray-100 dark:bg-[#121212] px-6 pb-6">
      <div className="w-full max-w-md bg-white dark:bg-[#1E1E1E] shadow-lg rounded-lg p-6 text-center">
        ...
        <p className="text-gray-600 dark:text-gray-400 mb-6">
          {isSignUp
            ? "Join the Virtual Art Gallery today!"
            : "Log in to continue exploring artworks."}
        </p>
        ...
        >
          ...
          <button
            type="submit"
            className="w-full bg-gray-900 text-white font-semibold py-3 rounded-md hover:opacity-90 dark:bg-gray-100 dark:text-gray-900  dark:hover:bg-gray-300 transition select-none"
          >
        ...
        <Link
          to="/"
          className="block mt-6 text-gray-500 dark:text-gray-300 hover:scale-105 transition"
        >
          Back to Home
        </Link>
      </div>
